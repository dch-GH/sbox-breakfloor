...
public partial class WalkController : BasePlayerController
{
	...
	[Net] public float Gravity { get; set; } = 750.0f; // This is 800 by default but we need it higher for block height.
	...
	private Breakfloor.Player Ply => (Breakfloor.Player)Pawn;
	...
	public override void FrameSimulate()
	{
		...
		EyeRotation = Ply.ViewAngles.ToRotation();
	}
	...
	public override void Simulate()
	{
		...
		//
		WishVelocity = new Vector3( Ply.InputDirection.x, Ply.InputDirection.y, 0 );
	...
	{
		var wishvel = new Vector3( Ply.InputDirection.x, Ply.InputDirection.y, 0 );
		wishvel *= Ply.ViewAngles.WithPitch( 0 ).ToRotation();
